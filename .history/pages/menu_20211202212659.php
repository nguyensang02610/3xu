...
<nav class="navbar navbar-expand-sm " style="background-color:#FF5403;">
   ...
   <ul class="navbar-nav ml-auto">
      <form class="form-inline" action="index.php?quanly=timkiem" method="POST" style="margin-right:100px">
         <input class="form-control mr-sm-2" type="text" placeholder="..." name="tukhoa" style="margin-left:100px">
