...
<nav class="navbar navbar-expand-sm " style="background-color:#FF5403;">
   ...
   <ul class="navbar-nav ml-auto">
      <form class="form-inline" action="index.php?quanly=timkiem" method="POST" style="margin-right:120px">
      ...
      ?>
         <li class="nav-item active">
            <a class="nav-link text-white" href="index.php?quanly=dangky" style="margin-top:10px"><i class="fas fa-user"></i> Đăng ký</a>
         </li>
      <?php
      }
      ?>
       <li class="nav-item active">
         <a class="nav-link text-white" href="index.php?quanly=giohang" style="margin-top:10px"><i class="fas fa-shopping-cart"></i></a>
      </li>
   </ul>
   </ul>
</nav>
