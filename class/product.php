...
class product //Lớp sản phẩm
{
	...
	public function insert_product($date, $files)
	{
		...
		else 
		{
			...
			$query = "INSERT INTO tbl_product(price,price_discount,sl_nhap,brand,tensp,tensp_shortcut,cpu,cpu_shortcut,hedieuhanh,gpu,gpu_shortcut,ram,ram_shortcut,ssd,ssd_shortcut,manhinh,manhinh_shortcut,wifi,banphim,kichthuoc,trongluong,description,image,img_1,img_2,img_3,img_4,img_5,img_6) 
			VALUES('$price', '$price_discount', '$sl_nhap', '$brand', '$tensp', '$tensp_shortcut', '$cpu', '$cpu_shortcut', '$hedieuhanh', '$gpu', '$gpu_shortcut', '$ram', '$ram_shortcut', '$ssd', '$ssd_shortcut', '$manhinh', '$manhinh_shortcut', '$wifi', '$banphim', '$kichthuoc','$trongluong','$description', '$anh_bia','$anh_1','$anh_2','$anh_3','$anh_4','$anh_5','$anh_6') ";
